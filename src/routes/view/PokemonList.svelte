      ...
      {#each pokemonList as pokemon}
        ...
        <div class="modal" id="{pokemon.name.toLowerCase()}">
          <div class="modal-box [&::-webkit-scrollbar]:hidden">
              ...
              {#each pokemon.abilities as ability}
                <div class="flex justify-center">
                  ...
                  {#if ability.is_hidden}
                    ...
                    <div class="group cursor-pointer relative inline-block w-24 text-center">
                      <!-- Ability name -->
            ...
            <div class="flex">
              <div class="grid gap-x-10 grid-rows-5 grid-cols-{pokemon.evolutionChain.length} grid-flow-col">
                {#each pokemon.evolutionChain as evolution}
                  ...
                  <h1 class="text-center font-bold text-lg">{evolution.name}</h1>
                {/each}
              </div>
            </div>
            
            <!-- TODO: Close button fixed to page OR close modal by clicking away -->
