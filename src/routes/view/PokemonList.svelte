    ...
    {:then}
      {#each pokemonList as pokemon}
        ...
        <div class="card group bg-base-100 shadow-xl m-4 transition ease-in-out hover:bg-base-300 active:scale-95 duration-150">
          <label for="{pokemon.name.toLowerCase()}" class="">
            ...
            <figure class="px-10 pt-10">
              <img src={pokemon.sprite} alt={pokemon.name} class="rounded-xl z-20" />
            </figure>
        ...
        <!--? Pokemon popup page -->
        <div class="modal modal-bottom sm:modal-middle" id="s">
